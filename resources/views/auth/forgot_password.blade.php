...
<div class="form-container">
    <div>
        ...
        <form method="POST" action="{{route('password.email')}}">
            @csrf
            <div class="card">
                Please type in your email in the form field below to get a password reset link in your inbox.
            </div>

            <div class="form-group">
                <input type="email" name="email" id="" class="form-control" placeholder="Type In Your Email" required>
            </div>

            <div class="form-group">
                <button class="btn btn-primary" type="submit">Request Password Reset Link</button>
