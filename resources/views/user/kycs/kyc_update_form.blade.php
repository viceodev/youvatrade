        ...
        <div class="row">
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <input class=" input-focus form-control rounded shadow" type="text" value = "{{ $kyc['firstname'] }}" id="first-name" name="first_name" placeholder="First Name" required>
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <div class="input-wrap">
                        <input class="input-focus form-control rounded shadow" value = "{{$kyc['lastname']}}" type="text" id="last-name" name="last_name" required>
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <div class="input-wrap">
                        <input class="input-focus form-control rounded shadow" type="text" value = "{{$kyc['phone']}}" id="phone-number" name="phone" >
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <div class="input-wrap">
                        <input class="input-focus form-control rounded shadow" type="date" value = "{{$kyc['dob']}}" id="date-of-birth" name="dob" >
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
        ...
        <div class="row">
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <span class="text-require text-danger">*</span>
                    <div class="input-wrap">
                        <input class="input-focus form-control rounded shadow" type="text" value = "{{$kyc['state']}}" id="state" name="state" required>
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <span class="text-require text-danger">*</span>
                    <div class="input-wrap">
                        <input class="input-focus form-control rounded shadow" type="text" value = "{{$kyc['city']}}" id="city" name="city" required>
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
            ...
            <div class="col-md-6 my-4">
                <div class="input-item input-with-label">
                    ...
                    <span class="text-require text-danger">*</span>
                    <div class="input-wrap">
                        <input class="input-focus form-control rounded shadow" type="text" value = "{{$kyc['zip']}}" id="zip" name="zip" required>
                    </div>
                </div>{{-- .input-item --}}
            </div>{{-- .col --}}
...
<div class="form-step form-step2">
    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <span class="text-require text-danger">*</span>
            <input type="file" name="front_doc" id="doc" class="form-control " value="null">            
        </div>

        <div class="form-group">
            <label for="doc">Upload the back-side view of your document</label>
            <span class="text-require text-danger">*</span>
            <input type="file" name="back_doc" id="doc" class="form-control">            
        </div>
...
<div class="form-step form-step-final">
    <div class="p-2">
        ...
        <div class="my-2">
            <input type="checkbox" name="read" id="read"  class="mr-2" checked required>
            <label for="read">I have read the Terms and Condition and Privacy and Policy.</label>
            <span class="text-require text-danger">*</span>
        </div>

        <div class="my-2">
            <input type="checkbox" name="correct" id="correct"  class="mr-2" checked required>
            <label for="correct">All the personal information I have entered is correct.</label>
            <span class="text-require text-danger">*</span>
        </div>

        <div class="my-2">
            <input type="checkbox" name="consent" id="consent"  class="mr-2" checked required>
        ...
        <div class="my-2">
            <input type="checkbox" name="understand" id="understand"  class="mr-2" checked required>
