...
<div class="page-wrapper">
    <div class="row page-titles">
        ...
        <h3 class="text-primary text-capitalize">Add Transaction</h3> </div>
        <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Funds</a></li>
        <li class="breadcrumb-item active text-capitalize">Add Transaction</li>
        </ol>
        </div>
    </div>
    ...
    <div class="page-header page-header-kyc mt-5 mt-lg-5 ">
        <div class="row justify-content-center pt-5 pt-lg-1 ">
            <div class="col-lg-8 col-xl-7 text-center">
                <h2 class="page-title text-uppercase">{{strtoupper($wallet['wallet_type'])}} TRANSACTION</h2>
